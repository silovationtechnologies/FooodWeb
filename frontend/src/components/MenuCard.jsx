        ...
        <div
                ...
                style={{
                    background: isSelected
                        ...
                        : '#0a0a0c',
                    border: '1px solid',
                    borderColor: isSelected ? 'rgba(0, 223, 196, 0.4)' : 'rgba(255, 255, 255, 0.08)',
                    opacity: item.is_available === false ? 0.6 : 1,
                    filter: item.is_available === false ? 'grayscale(0.5)' : 'none',
                    boxShadow: isSelected
                        ? '0 0 40px rgba(0, 223, 196, 0.15)'
                        : 'none',
                    display: 'flex',
            ...
            <div style={{
                ...
                {item.is_signature && (
                    <div style={{
                        ...
                        padding: '3px 9px',
                        borderRadius: '20px',
                        background: 'var(--badge-signature)',
                        color: '#050507',
                        fontSize: '0.6rem',
                        fontWeight: '800',
                    ...
                    {cartQuantity > 0 ? (
                        ...
                        <button
                            ...
                            style={{
                                ...
                                color: item.is_available === false ? 'rgba(255,255,255,0.2)' : '#fff',
                                fontWeight: '700',
                                fontSize: '0.88rem',
                                borderRadius: '20px',
